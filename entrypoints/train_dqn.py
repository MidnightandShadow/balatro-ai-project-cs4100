...
def main():
    ...
    for game_num in range(1, NUM_GAMES + 1):
        print_if(
            game_num,
            f"=== STARTING GAME #{game_num} {win_counter=} {agent.eps_threshold=:.3f} {avg_score_chips=:.3f} {avg_reward_per_hand=:.3f} ===",
        )
        ...
        while not done:
            ...
            try:
                ...
                if (
                    ...
                    avg_reward_per_hand = (
                        1 - ALPHA
                    ) * avg_reward_per_hand + ALPHA * score_delta
        ...
        avg_score_chips = (1 - ALPHA) * avg_score_chips + ALPHA * (
            env.game_state.scored_chips
        )
